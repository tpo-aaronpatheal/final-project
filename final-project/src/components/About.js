                        ...
                        <div className="page">
                            ...
                            <div className="row">
                                <div className="col-md-9">
                                    ...
                                    <p> Our vision has always been and will always be to show you the world of movie entertainment! </p>

                                    <p>The mission of A-Money Productions is to entertain, thrill, and enrich our community by opening the door to a global library of cinematic entertainment. Providing a safe, fun, and welcoming environment are some of our many top priorities.</p>
                                </div>
                                <div className="col-md-3">
                                    <h2 className="section-title">Useful Links</h2>
                                    <ul className="arrow">
                                        <li><NavLink to="/tv">Watch at Home</NavLink></li> 
